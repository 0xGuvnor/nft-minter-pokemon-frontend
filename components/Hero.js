...
const style = {
    ...
    mintButton: `text-[0.7rem] sm:text-sm md:text-md text-center font-bold w-1/2 md:w-1/3 py-4 px-2 bg-[#04E762] md:rounded-full rounded-lg hover:bg-[#89FC00] transition ease-in-out delay-150 duration-300 hover:-translate-y-1 hover:scale-110`,
    openseaButton: `text-[0.7rem] sm:text-sm md:text-md text-center font-bold w-1/2 md:w-1/3 py-4 px-2 bg-[#576066] md:rounded-full rounded-lg text-white  hover:bg-[#7D8491] transition ease-in-out delay-150 duration-300 hover:-translate-y-1 hover:scale-110`,
    cardContainer: `drop-shadow-2xl h-[16em] w-[16rem] sm:h-[28rem] sm:w-[28rem] lg:h-[30rem] lg:w-[30rem] xl:h-[36rem] xl:w-[36rem] -mt-44 sm:mt-0 md:mb-12`,
