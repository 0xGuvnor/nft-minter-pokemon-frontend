...
const style = {
    ...
    mintButton: `text-[0.7rem] sm:text-sm md:text-md text-center font-bold w-1/3 py-4 px-2 bg-[#04E762] md:rounded-full rounded-lg hover:bg-[#89FC00] transition ease-in-out delay-150 duration-300 hover:-translate-y-1 hover:scale-110`,
